...
@stop
@section('page-title', 'Add Output - '.$plan->activity->name)
    ...
    <form action="/output" method="post">
        ...
        <div class="row">
            ...
            <div class="col col-lg-6 col-md-12 col-sm-12 form-group" id="projects">
                ...
                <span class="small btn-new"><a href="/project/create" class="add-ajax-item" data-add="add-project" data-target="'projects" data-title="Add New Project"> New </a></span>
            </div>
            ...
            {{--SubComponent--}}
            <div class="col col-lg-6 col-md-12 col-sm-12 form-group" id="subcomponents">
                ...
                <i class="form-group__bar"></i>
                <span class="small btn-new"><a href="/components/create" class="add-ajax-item" data-add="add-component" data-target="components" data-title="Add New Subcomponent"> New </a></span>
            </div>


            {{--SubComponent--}}
            <div class="col col-lg-6 col-md-12 col-sm-12 form-group" id="activities">
                {{ Form::label('acitivity_id', 'Activity') }}
                <select id="activity_id" name="activity_id" class="select2-ajax form-control" placeholder="Select a subcomponent...."></select>
                <i class="form-group__bar"></i>
                <span class="small btn-new"><a href="/components/create" class="add-ajax-item" data-add="add-component" data-target="components" data-title="Add New Subcomponent"> New </a></span>
            </div>
            ...
            <div class="col col-lg-6 col-md-12 col-sm-12 form-group">
                {{ Form::label('unit-id', 'Unit') }}
                {{ Form::select('unit_id', $units, null, ['class' => 'form-control select2', 'placeholder' => 'Choose Unit...']) }}
                <i class="form-group__bar"></i>
                <span class="small btn-new"><a href="/components/create" class="add-ajax-item" data-add="add-component" data-target="components" data-title="Add New Component"> New </a></span>
            </div>
            ...
            <div class="col col-lg-6 col-md-12 col-sm-12 form-group">
                ...
                {{ Form::select('indicator_id', $indicators, null, ['class' => 'form-control select2', 'placeholder' => 'Choose Indicator...']) }}
                <i class="form-group__bar"></i>
                <span class="small btn-new"><a href="#" class="add-ajax-item" data-add="add-component" data-target="components" data-title="Add New Component"> New </a></span>
            </div>
