                    ...
                    <form action="/irrigation_scheme" method="post" enctype="multipart/form-data" class="js-validation-bootstrap">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-9" v-if="scheme">
                               {!! Form::select('scheme_id', $schemes, null, ['class' => 'form-control select2', 'placeholder' => 'Select Scheme...', 'required' => 'required']) !!}

                            </div>
                            {{-- Scheme Not Listed --}}
              
                            <div class="col-md-5" v-if="manualScheme">
                               {!! Form::text('scheme_name', null, ['class' => 'form-control', 'placeholder' => 'Scheme Name', 'required' => 'required']) !!}
                              
                            </div>
                            <div class="col-md-4" v-if="manualScheme">
                                {!! Form::text('scheme_code', null, ['class' => 'form-control', 'placeholder' => 'Scheme Code', 'required' => 'required']) !!}
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-9" v-if="village">
                               {!! Form::select('village_id', $villages, null, ['class' => 'form-control select2', 'placeholder' => 'Select Village...', 'required' => 'required']) !!}
                              
                            </div>
                              {{-- Village Not Listed --}}
                            <div class="col-md-5" v-if="manualVillage">
                                {!! Form::text('village_name', null, ['class' => 'form-control', 'placeholder' => 'Village Name', 'required' => 'required']) !!}
                               
                             </div>
                             <div class="col-md-4" v-if="manualVillage">
                                 {!! Form::select('district_id', $districts, null, ['class' => 'form-control select2', 'placeholder' => 'Select District...', 'required' => 'required']) !!}
                        ...
                        {{-- End of IA Not Listed --}}
                         ...
                         <div class="form-group row">
                            ...
                            <div class="col-md-9" v-if="IA">
                               {!! Form::select('ia_id', $IAs, null, ['class' => 'form-control select2', 'placeholder' => 'Select IA...', 'required' => 'required']) !!}
                              
                            </div>
                            <div class="col-md-9" v-if="manualIA">
                                {!! Form::text('ia_name', null, ['class' => 'form-control', 'placeholder' => 'IA Name', 'required' => 'required']) !!}
                             </div>
                            <div class="col-3">
                                <label class="css-control css-control-primary css-checkbox">
                        ...
                        <div class="form-group row manual">
                            ...
                            <div class="col-md-6">
                               {!! Form::text('start_point_long', null, ['class' => 'form-control', 'placeholder' => 'Longitude', 'required' => 'required']) !!}  
                            </div>

                            <div class="col-md-6">
                                {!! Form::text('start_point_lat', null, ['class' => 'form-control', 'placeholder' => 'Latitude', 'required' => 'required']) !!}  
                             </div>
                        </div>
                        {{-- End of start point --}}
                         ...
                         <div class="form-group row manual">
                            ...
                            <div class="col-md-6">
                               {!! Form::text('end_point_long', null, ['class' => 'form-control', 'placeholder' => 'Longitude', 'required' => 'required']) !!}  
                            </div>

                            <div class="col-md-6">
                                {!! Form::text('end_point_lat', null, ['class' => 'form-control', 'placeholder' => 'Latitude', 'required' => 'required']) !!}  
                             </div>
                        </div>
                        {{-- End of end point --}}
                       ...
                       <div class="form-group row">
                        ...
                        {{-- Start Date END --}}
                          ...
                          <div class="form-group row manual">
                            ...
                            <div class="col-md-4">
                               {!! Form::text('total_command_area', null, ['class' => 'form-control', 'placeholder' => 'Total Command Area', 'required' => 'required']) !!}  
                            </div>

                            <div class="col-md-4">
                                {!! Form::text('irrigated_area', null, ['class' => 'form-control', 'placeholder' => 'Irrigated Area', 'required' => 'required']) !!}  
                             </div>

                             <div class="col-md-4">
                                {!! Form::text('nonirrigated_area', null, ['class' => 'form-control', 'placeholder' => 'Nonirrigated Area']) !!}  
                             </div>
                        </div>
                        {{-- Command Area and Irrigated Area --}}
                         ...
                         <div class="form-group row manual">
                            ...
                            <div class="col-md-6">
                               {!! Form::text('direct_beneficiaries', null, ['class' => 'form-control', 'placeholder' => 'Direct Beneficiaries', 'required' => 'required']) !!}  
                            </div>

                            <div class="col-md-6">
                                {!! Form::text('indirect_beneficiaries', null, ['class' => 'form-control', 'placeholder' => 'Indirect Beneficiaries', 'required' => 'required']) !!}  
                             </div>
                        </div>
                        {{-- Direct Beneficiaries and Indirect Beneficiares --}}
                          ...
                          <div class="form-group row manual">
                            ...
                            <div class="col-md-6">
                               {!! Form::text('engineering_estimated_cost', null, ['class' => 'form-control', 'placeholder' => 'Afs', 'required' => 'required']) !!}  
                            </div>

                            <div class="col-md-6">
                                {!! Form::text('engineering_estimated_cost_usd', null, ['class' => 'form-control', 'placeholder' => 'USD', 'required' => 'required']) !!}  
                             </div>
                        </div>
                        {{-- Engineering Estimated Cost --}}
                         ...
                         {{-- contract  Cost --}}
                          <div class="form-group row manual">
                            ...
                            <div class="col-md-6">
                               {!! Form::text('contract_cost', null, ['class' => 'form-control', 'placeholder' => 'Afs', 'required' => 'required']) !!}  
                            </div>

                            <div class="col-md-6">
                                {!! Form::text('contract_cost_usd', null, ['class' => 'form-control', 'placeholder' => 'USD', 'required' => 'required']) !!}  
                             </div>
                        </div>
                        {{-- contract  Cost --}}
                          ...
                          <div class="form-group row manual">
                            ...
                            <div class="col-md-6">
                               {!! Form::text('project_status', null, ['class' => 'form-control', 'placeholder' => 'Project Status', 'required' => 'required']) !!}  
                            </div>
                    ...
                    <table
                        ...
                        <tbody>
                                ...
                                @foreach($irrigationSchemes as $is)
                                    <tr data-scheme="{{ $is->id }}" class="scheme">
                                        <td>{{ $x++ }}</td>
                                        <td>{{ $is->scheme->name }} <a href="/scheme/{{ $is->id }}/edit"><i class="fa fa-pencil"></i></a></td>
